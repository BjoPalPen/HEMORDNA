...
builder.Services.AddScoped<ResetHousehold>();
...
builder.Services.AddScoped<SetMemberCanManageHousehold>();
...
builder.Services.AddScoped<CreateExtraTask>();
...
builder.Services.AddScoped<BringOccurrenceForward>();
builder.Services.AddScoped<UndoBringForward>();
builder.Services.AddScoped<SetMemberDayOff>();
builder.Services.AddScoped<ClearMemberDayOff>();
builder.Services.AddScoped<GetMemberTimeCredit>();
...
builder.Services.AddScoped<CreateReminder>();
builder.Services.AddScoped<GetOwnReminders>();
builder.Services.AddScoped<GetHouseholdReminders>();
builder.Services.AddScoped<ChangeReminderTitle>();
builder.Services.AddScoped<ChangeReminderLocation>();
builder.Services.AddScoped<ChangeReminderVisibility>();
builder.Services.AddScoped<SetReminderAudience>();
